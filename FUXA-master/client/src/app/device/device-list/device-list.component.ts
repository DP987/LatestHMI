...
export class DeviceListComponent implements OnInit, AfterViewInit {
    ...
    getAddress(tag: Tag) {
        ...
        if (this.deviceSelected.type === DeviceType.ModbusRTU || this.deviceSelected.type === DeviceType.ModbusTCP || this.deviceSelected.type === DeviceType.ModbusTCPDLL) {
    ...
    isToEdit(type, tag: Tag) {
        if (type === DeviceType.SiemensS7 || type === DeviceType.ModbusTCP || type === DeviceType.ModbusTCPDLL || type === DeviceType.ModbusRTU ||
