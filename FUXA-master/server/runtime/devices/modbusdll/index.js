...
// const Module = require('./fileprocessor.js');

 const dotnet = require('./dotnetapp/dotnet');
...
//import { Module } from 'D:/PCI/Fuxa/latest/FUXA-master/server/runtime/devices/modbusdll/dotnetapp/dotnet.js';

 //const dotnetPath = 'D:/PCI/Fuxa/latest/FUXA-master/server/runtime/devices/modbusdll/dotnetapp/dotnet.js';

 //const Module = require(dotnetPath);
...
function MODBUSclient(_data, _logger, _events) {
    ...
    this.init = function (_type) {
        type = _type;
        console.log("------------------------------12------------------------------");
         //Module.Init("127.0.0.1", 502, 1000);
         console.log("------------------------------13------------------------------");
         //onst connectionStatus = Module.ToggleConnection();
    ...
    const init = async () => {
        ...
        console.log("init start");
         ...
         const result = await react.FileProcessor.Init("127.0.0.1",502,1000)
        console.log("init start" , result);
        alert(`Add: ${result}`);
       }
       ...
       const open = async () => {
        ...
        const result = await dotnet.FileProcessor.ToggleConnection()
        console.log("open" , result);
        alert(`Add: ${result}`);
       }

    
       //D:\Microsoft\demoappdotnetapp/bin/Release/net7.0/browser-wasm/AppBundle/dotnet.js
       
       //const dotnetPath = 'file:///D:/PCI/Fuxa/latest/FUXA-master/server/runtime/devices/modbusdll/dotnetapp/dotnet.js';
    //    const dotnetPath = 'file:///D:/Microsoft/demoapp/dotnetapp/bin/Release/net7.0/browser-wasm/AppBundle/dotnet.js';
    // const { dotnet } =  useDotNet(dotnetPath);

  //const { dotnet } = useDotNet('D:/PCI/Fuxa/latest/FUXA-master/server/runtime/devices/modbusdll/dotnetapp/dotnet.js')
 
 // const { dotnet } = useDotNet('dotnetapp/dotnet.js')


    // const useDotNet = (url) => {

    //     const dotnetUrl = useRef('');
    //     const [dotnet_, setDotNet] = useState(null);
...
// const useDotNet = async (url) => {
//     console.log("--------------1---------------");
//     const module = await import(/* @vite-ignore */ new URL(url, 'file:///'));
//     const { getAssemblyExports, getConfig } = await module
//         .dotnet
//         .withDiagnosticTracing(false)
//         .create();
...
// const useDotNet = async (path) => {
//     debugger;
//     console.log("--------------1---------------", new URL(path));
//     const module = await import(/* @vite-ignore */ new URL(path));
//     console.log("--------------10---------------");
